...
<div class="register-container container">
            <!--   <div class="row"> -->
                 ...
                 <div class="register span6">
                    <table align="center" cellpadding="8" cellspacing="8" border="0" bgcolor="lightblue">
                    	<tr bgcolor="skyblue">
                    		<th>Employee Code</th>
                    		<th>Employee Name</th>
                    		<th>Department ID</th>
                    		...
                    		try{
                    			...
                    			while(rs.next()){
                    				%>
                    					...
                    					<th><a href="editEmp.jsp?editR=<%=rs.getString(1)%>"><input type="button" value="Edit"></a></th>
                    						<th><a href="deleteEmp.jsp?deletE=<%=rs.getString(1)%>"><input type="button" value="Delete"></a></th>
                    					</tr>
                    				<%
                    			}
                    		}catch(Exception e){
