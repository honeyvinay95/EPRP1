...
/*	try {
	...
	Session sess = Session.getDefaultInstance(props,
		...
		message.setText("Dear "+request.getParameter("ename")+""+
				...
				"" +
				"We are very thankful to join us. We are sending you" 
				+"employee code and password to get logged in and check your performance and apraisal.  " +
				"" +
				"" +
				"" +
				"" +
				"Your Employee Code is: "+Integer.parseInt(request.getParameter("ecode"))+"" +
						"\n\n   Password: "+request.getParameter("upass")+"" +
								"\n\n Your Register Mobile Number is: "+request.getParameter("mob")+""+"\n\n Your Role in the company is: "+request.getParameter("role")+""); 
 ...
 */	
	...
	pst.setString(4, request.getParameter("doj"));
	...
	pst.setString(11, request.getParameter("dob"));
