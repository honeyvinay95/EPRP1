...
{window.history.forward();}
function validate(){
	var user=document.fr1.mcode.value;
...
<div class="register-container container">
            <!--   <div class="row"> -->
                 ...
                 <div class="register span6">
                    <form action="M1.jsp" method="post">
                        <h2>SignIn TO <span class="light blue"><strong>EPR Portal</strong></span></h2>
                        
                  
                        <label for="username">Manager Code</label>
                        <input type="text" id="mcode" name="mcode" placeholder="choose a username...">
